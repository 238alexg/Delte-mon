...
namespace BattleDelts
{
    public class MainMenuManager : MonoBehaviour
    {
        ...
        public void LoadGame()
        {
            ...
            {
                UIManager.Inst.StartMessage("There is no previous save!");
            }
        }
        ...
        public void NewGame()
        {
            ...
            if (load != null)
            {
                UIManager.Inst.StartMessage("If you want to start a new game, you must delete this save file first!");
            }
            else
            {
                ...
                UIManager.Inst.SwitchLocationAndScene(-5, 0, "New Game");
            }
        }
        ...
        public void DeleteSave()
        {
            ...
            if (load != null)
            {
                ...
                {
                    UIManager.Inst.StartMessage("WARNING: If the Delete button is pressed again this save file WILL be deleted FOREVER!");
                    DeleteSaveText.text = "Confirm Delete?";
                }
            }
            else
            {
                UIManager.Inst.StartMessage("There is no previous save to delete!");
            }
        }
    }
}